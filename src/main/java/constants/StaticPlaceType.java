...
public class StaticPlaceType {
    ...
    public static final String SECONDARY_SCHOOL_VN = "Trường trung học";
    public static final String BUS_STATION = "bus_station";
    public static final String BUS_STATION_VN = "Trạm xe buýt";
    public static final String ATM = "atm";
    public static final String ATM_VN = "Trạm ATM";
    public static final String BANK = "bank";
    public static final String BANK_VN = "Ngân hàng";
